	...
	do -- ui Elements
		...
		function window:createTab(options)
			...
			do -- create UI elements
				...
				function tab:createPage(options)
					options = library:validate({
						name = "name",
						subtext = "subtext"
					}, options or {} )
					...
					do -- render
						-- Starterpage.MatLib.MainWindow.PageContainer.ElementContainer.ElementSample
						page["2c"] = Instance.new("Frame", tab["2a"]);
						page["2c"]["BorderSizePixel"] = 0;
						page["2c"]["BackgroundColor3"] = themeColours.componentBase;
						page["2c"]["Size"] = UDim2.new(1, -6, 0, 30);
						page["2c"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
						page["2c"]["Name"] = [[ElementSample]];
						page["2c"]["ClipsDescendants"] = true
						page["2c"]["BackgroundTransparency"] = 0.4

						-- Starterpage.MatLib.MainWindow.PageContainer.ElementContainer.ElementSample.UICorner
						page["2d"] = Instance.new("UICorner", page["2c"]);
						page["2d"]["CornerRadius"] = UDim.new(0, 3);

						-- Starterpage.MatLib.MainWindow.PageContainer.ElementContainer.ElementSample.Heading
						page["2e"] = Instance.new("TextLabel", page["2c"]);
						page["2e"]["TextWrapped"] = true;
						page["2e"]["BorderSizePixel"] = 0;
						page["2e"]["TextScaled"] = true;
						page["2e"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
						page["2e"]["TextXAlignment"] = Enum.TextXAlignment.Left;
						page["2e"]["FontFace"] = Font.new([[rbxassetid://12187373327]], Enum.FontWeight.Regular, Enum.FontStyle.Normal);
						page["2e"]["TextStrokeColor3"] = Color3.fromRGB(255, 255, 255);
						page["2e"]["TextSize"] = 14;
						page["2e"]["TextColor3"] = themeColours.text;
						page["2e"]["Size"] = UDim2.new(1, 0, 1, 0);
						page["2e"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
						page["2e"]["Text"] = options['name'];
						page["2e"]["Name"] = [[Heading]];
						page["2e"]["BackgroundTransparency"] = 1;

						-- Starterpage.MatLib.MainWindow.PageContainer.ElementContainer.ElementSample.Heading.UIPadding
						page["2f"] = Instance.new("UIPadding", page["2e"]);
						page["2f"]["PaddingBottom"] = UDim.new(0, 15);
						page["2f"]["PaddingLeft"] = UDim.new(0, 5);

						-- Starterpage.MatLib.MainWindow.PageContainer.ElementContainer.ElementSample.Label
						page["30"] = Instance.new("TextLabel", page["2c"]);
						page["30"]["TextWrapped"] = true;
						page["30"]["BorderSizePixel"] = 0;
						page["30"]["TextScaled"] = true;
						page["30"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
						page["30"]["TextXAlignment"] = Enum.TextXAlignment.Left;
						page["30"]["FontFace"] = Font.new([[rbxassetid://12187373327]], Enum.FontWeight.Regular, Enum.FontStyle.Normal);
						page["30"]["TextStrokeColor3"] = Color3.fromRGB(255, 255, 255);
						page["30"]["TextSize"] = 14;
						page["30"]["TextColor3"] = themeColours.subText;
						page["30"]["Size"] = UDim2.new(1, 0, 1, 0);
						page["30"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
						page["30"]["Text"] = options['subtext'];
						page["30"]["Name"] = [[Label]];
						page["30"]["BackgroundTransparency"] = 1;

						-- Starterpage.MatLib.MainWindow.PageContainer.ElementContainer.ElementSample.Label.UIPadding
						page["31"] = Instance.new("UIPadding", page["30"]);
						page["31"]["PaddingTop"] = UDim.new(0, 15);
						page["31"]["PaddingBottom"] = UDim.new(0, 3);
						page["31"]["PaddingLeft"] = UDim.new(0, 5);
						
						-- Starterbutton.MatLib.MainWindow.ElementsContainer.PageSample.ButtonSample.pointer
						page["14"] = Instance.new("ImageButton", page["2c"]);
						page["14"]["ZIndex"] = 2;
						page["14"]["ImageColor3"] = themeColours.accent
						page["14"]["LayoutOrder"] = 5;
						page["14"]["AnchorPoint"] = Vector2.new(1, 0.5);
						page["14"]["Image"] = [[rbxassetid://3926305904]];
						page["14"]["ImageRectSize"] = Vector2.new(36, 36);
						page["14"]["Size"] = UDim2.new(0, 25, 0, 25);
						page["14"]["Name"] = [[pointer]];
						page["14"]["ImageRectOffset"] = Vector2.new(684, 724);
						page["14"]["Position"] = UDim2.new(1, -3, 0.5, 0);
						page["14"]["BackgroundTransparency"] = 1;
						
						
						do -- create new page
							-- Starterpage.MatLib.MainWindow.ElementsContainer.PageSample
							page["b"] = Instance.new("ScrollingFrame", window["a"]);
							page["b"]["ZIndex"] = 2;
							page["b"]["BorderSizePixel"] = 0;
							page["b"]["CanvasSize"] = UDim2.new(0, 0, 0, 0);
							page["b"]["TopImage"] = [[rbxasset://textures/ui/Scroll/scroll-middle.png]];
							page["b"]["BackgroundColor3"] = themeColours.background;
							page["b"]["AnchorPoint"] = Vector2.new(0, 0);
							page["b"]["AutomaticCanvasSize"] = Enum.AutomaticSize.Y;
							page["b"]["Size"] = UDim2.new(0.6499999761581421, 0, 1, 0);
							page["b"]["ScrollBarImageColor3"] = Color3.fromRGB(63, 62, 65);
							page["b"]["Selectable"] = false;
							page["b"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
							page["b"]["ScrollBarThickness"] = 3;
							page["b"]["Position"] = UDim2.new(1, 0, 0, 0);
							page["b"]["Name"] = options.name;
							page["b"]["BottomImage"] = [[rbxasset://textures/ui/Scroll/scroll-middle.png]];
							page["b"]["SelectionGroup"] = false;
							page["b"]["ClipsDescendants"] = true

							-- Starterpage.MatLib.MainWindow.ElementsContainer.PageSample.UIListLayout
							page["c"] = Instance.new("UIListLayout", page["b"]);
							page["c"]["HorizontalAlignment"] = Enum.HorizontalAlignment.Center;
							page["c"]["Padding"] = UDim.new(0, 3);
							page["c"]["SortOrder"] = Enum.SortOrder.LayoutOrder;

							-- Starterpage.MatLib.MainWindow.ElementsContainer.PageSample.UIPadding
							page["d"] = Instance.new("UIPadding", page["b"]);
							page["d"]["PaddingTop"] = UDim.new(0, 3);
							page["d"]["PaddingRight"] = UDim.new(0, 3);
							page["d"]["PaddingBottom"] = UDim.new(0, 3);
							
							-- StarterGui.MatLib.MainWindow.UICorner
							page["9"] = Instance.new("UICorner", window["b"]);
							page["9"]["CornerRadius"] = UDim.new(0, 2);
							
							-- Starterpage.MatLib.MainWindow.ElementsContainer.PageSample.Title
							page["e"] = Instance.new("TextLabel", page["b"]);
							page["e"]["BorderSizePixel"] = 0;
							page["e"]["TextYAlignment"] = Enum.TextYAlignment.Bottom;
							page["e"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
							page["e"]["TextXAlignment"] = Enum.TextXAlignment.Left;
							page["e"]["FontFace"] = Font.new([[rbxasset://fonts/families/Ubuntu.json]], Enum.FontWeight.Regular, Enum.FontStyle.Normal);
							page["e"]["TextSize"] = 14;
							page["e"]["TextColor3"] = themeColours.subText;
							page["e"]["Size"] = UDim2.new(1, 0, 0, 10);
							page["e"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
							page["e"]["Text"] = options['name'];
							page["e"]["Name"] = [[Title]];
							page["e"]["BackgroundTransparency"] = 1;

							-- Starterpage.MatLib.MainWindow.ElementsContainer.PageSample.Title.UIPadding
							page["f"] = Instance.new("UIPadding", page["e"]);
							page["f"]["PaddingLeft"] = UDim.new(0, 3);
							page["f"]["PaddingTop"] = UDim.new(0,5)
						end
						
					end
					
					do -- logic
						library:rippleEffect(page['2c'], page)
						
						page['2c'].MouseEnter:Connect(function()
							if page.active == false and window.pageActive == false then
								page.hover = true
								library:tween(page['2c'], {BackgroundTransparency = 0})
							end
						end)
						
						page['2c'].MouseLeave:Connect(function()
							page.hover = false
							library:tween(page['2c'], {BackgroundTransparency = 0.4})
						end)
						
						uis.InputBegan:Connect(function(input, gpe)
							if input.UserInputType == Enum.UserInputType.MouseButton1 and page.hover == true and window.pageActive == false and page.debounce == false then
								
								page.debounce = true
								
								window.pageActive = true
								window['a'].Visible = true
								
								library:tween(page['b'], {AnchorPoint = Vector2.new(1,0)})
								library:tween(window['26'], {AnchorPoint = Vector2.new(1,1)})
								library:tween(window['a'], {BackgroundTransparency = 0.5})
								
							end
						end)
						
						window['28'].MouseButton1Click:Connect(function()
							
							window.pageActive = false
							
							library:tween(page['b'], {AnchorPoint = Vector2.new(0,0)})
							library:tween(window['26'], {AnchorPoint = Vector2.new(0,1)})
							library:tween(window['a'], {BackgroundTransparency = 1}, function()
								window['a'].Visible = false
								page.debounce = false
								window.pageActive = false
							end)
					...
					do -- page elements
						...
						function page:createButton(options)
							...
							do -- render
								...
								button["10"] = Instance.new("Frame", page["b"]);
								button["10"]["ZIndex"] = 2;
						...
						function page:createToggle(options)
							...
							do -- render
								...
								tog["15"] = Instance.new("Frame", page["b"]);
								tog["15"]["ZIndex"] = 2;
						...
						function page:createTextBox(options)
							...
							do -- render
								...
								textbox["15"] = Instance.new("Frame", page["b"]);
								textbox["15"]["ZIndex"] = 2;
						...
						function page:createKeyBind(options)
							options = library:validate({
								name = "",
								subtext = "",
								keybind = nil,
							...
							do -- render
								...
								keybind["15"] = Instance.new("Frame", page["b"]);
								keybind["15"]["ZIndex"] = 2;
						...
						function page:createLabel(options)
							...
							do -- render
								-- Starterkeybind.MatLib.MainWindow.ElementsContainer.PageSample.keybindgleSample
								label["15"] = Instance.new("Frame", page["b"]);
								label["15"]["ZIndex"] = 2;
						...
						function page:createHeading(options)
							options = library:validate({
								name = "",
								subtext = "",
							}, options or {} )
							...
							do -- render
								-- Starterkeybind.MatLib.MainWindow.ElementsContainer.PageSample.keybindgleSample
								heading["15"] = Instance.new("Frame", page["b"]);
								heading["15"]["ZIndex"] = 2;
						...
						function page:createDropdown(options)
							...
							do -- render
								-- Starterbutton.MatLib.MainWindow.ElementsContainer.PageSample.ButtonSample
								dropdown["10"] = Instance.new("Frame", page["b"]);
						...
						function page:createColorPicker(options)
							options = library:validate({
								name = "name",
								subtext = "",
							...
							do -- render
								-- Starterbutton.MatLib.MainWindow.ElementsContainer.PageSample.ButtonSample
								picker["10"] = Instance.new("Frame", page["b"]);
								picker["10"]["ZIndex"] = 2;
